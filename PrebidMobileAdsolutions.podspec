Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
    ...
    DESC
  s.homepage     = "https://www.adsolutions.com"
  ...
  s.author             = { "adsolutions" => "headerbidding@adsolutions.com" }
  s.platform     = :ios, "8.0"
  s.source       = { :git => "https://github.com/olafbuitelaar/prebid-mobile-ios.git", :tag => "#{s.version}" }
